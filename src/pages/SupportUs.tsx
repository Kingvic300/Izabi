    ...
    const handleSubmitKey = async (e: React.FormEvent) => {
        ...
        try {
            ...
            appToast.success({
                ...
                description:
                    'Thank you for supporting Izabi! Your API key has been secured.',
            });
        } catch (err: any) {
        ...
        >
            ...
            <div className="support-header space-y-4 text-center">
                ...
                <p className="text-muted-foreground font-medium text-xl max-w-2xl mx-auto">
                    Help us keep Izabi free and powerful for everyone by
                    contributing your own AI resources.
                </p>
            </div>
                    ...
                    <Card className="support-card glass shadow-2xl border-foreground/5 rounded-2xl overflow-hidden group">
                        <CardHeader className="p-6 md:p-10 pb-4 md:pb-6">
                            ...
                            <CardDescription className="text-lg">
                                Submitting your Groq API key helps reduce our
                                operational costs, allowing us to serve more
                                students.
                            </CardDescription>
                        </CardHeader>
                            ...
                            {isSubmitted ? (
                                ...
                                >
                                    <div className="space-y-4">
                                        <Label
                                            htmlFor="apiKey"
                                            className="text-xs uppercase tracking-[0.2em] font-bold opacity-40"
                                        >
                                            Groq API Key
                                        </Label>
                                    ...
                                    <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10 flex items-start gap-4">
                                        ...
                                        <p className="text-sm font-medium opacity-80 leading-relaxed">
                                            ...
                                            securely. We only use it to power AI
                                            requests on the platform when
                                            needed.
                                        </p>
                                    </div>
                    ...
                    <div className="support-card grid grid-cols-2 gap-6">
                        <Card className="glass border-foreground/5 p-8 rounded-2xl space-y-4 hover-lift">
                            ...
                            <div>
                                ...
                                <p className="text-sm opacity-60 font-medium leading-normal">
                                    Tell your classmates about Izabi. Growth is
                                    support.
                                </p>
                            </div>
                        </Card>
                        <Card className="glass border-foreground/5 p-8 rounded-2xl space-y-4 hover-lift">
                            ...
                            <div>
                                ...
                                <p className="text-sm opacity-60 font-medium leading-normal">
                                    Top-tier encryption for all contributed
                                    keys.
                                </p>
                            </div>
                        </Card>
