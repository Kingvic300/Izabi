...
const Login = () => {
    ...
    const handleGoogleSuccess = async (credentialResponse: any) => {
        ...
        try {
            ...
            let description = "Something went wrong during Google authentication.";
            
            if (status === 404) {
                description = "Authentication service is currently unavailable. Please contact support.";
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                            ...
                            <div className="relative my-6">
                                ...
                                <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest">
                                    <span className="bg-background px-4 text-muted-foreground/40">Or continue with neural sync</span>
                                </div>
                            </div>
