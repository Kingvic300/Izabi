...
const NotFound = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="min-h-screen bg-background relative overflow-hidden flex flex-col items-center justify-center p-4 sm:p-6"
        >
            <Link to="/" className="absolute top-5 left-4 sm:top-8 sm:left-8 group fade-in">
