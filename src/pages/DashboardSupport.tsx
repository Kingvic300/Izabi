...
import { Mail, Phone, MessageCircle, HelpCircle, ExternalLink } from "lucide-react"
...
export default function DashboardSupport() {
    ...
    useGSAP(() => {
        ...
        tl.fromTo(".page-header", { opacity: 0, y: -20 }, { opacity: 1, y: 0, duration: 0.8, ease: "expo.out" })
          .fromTo(".contact-card", 
              { opacity: 0, y: 30 }, 
              { 
                  opacity: 1, 
    ...
    return (
        <div ref={containerRef} className="space-y-8 w-full pb-20 px-4 md:px-8 lg:px-12 pt-6 md:pt-12">
            {/* Header Section */}
            <div className="page-header space-y-4">
                ...
                <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-2xl leading-relaxed">
                    Need help or have questions? Reach out to our support team directly. We are here to assist you.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="contact-card glass border-foreground/5 rounded-[32px] overflow-hidden shadow-xl hover:shadow-2xl transition-all group">
                    <CardHeader className="p-8 pb-4">
                        ...
                        <CardDescription className="text-base font-medium">
                            Send us a detailed message and we'll get back to you shortly.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="p-8 pt-2 space-y-4">
                        ...
                        <Button 
                            ...
                            onClick={() => window.open('mailto:victor7ishola@gmail.com')}
                        >
                            <Mail size={16} />
                            Send Email
                        </Button>
                ...
                <Card className="contact-card glass border-foreground/5 rounded-[32px] overflow-hidden shadow-xl hover:shadow-2xl transition-all group">
                    <CardHeader className="p-8 pb-4">
                        ...
                        <CardTitle className="text-2xl font-bold">WhatsApp Support</CardTitle>
                        <CardDescription className="text-base font-medium">
                    ...
                    <CardContent className="p-8 pt-2 space-y-4">
                        ...
                        <Button 
                            ...
                            onClick={() => window.open('https://wa.me/2348144782521', '_blank')}
                        >
            ...
            <div className="contact-card bg-card/5 border border-foreground/5 rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="space-y-2 text-center md:text-left">
                    ...
                    <p className="text-muted-foreground font-medium">
                        Check our FAQ section for quick answers to common questions about accounts, exams, and AI features.
                    </p>
                </div>
                <Button variant="outline" className="h-14 px-8 rounded-2xl text-base font-bold gap-2 hover:bg-card/10 border-foreground/10 shrink-0">
