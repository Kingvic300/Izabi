    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-background relative overflow-hidden">
            ...
            <section className="relative pt-44 pb-20">
                <div className="w-full px-6 lg:px-12 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 glass rounded-full border border-white/10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-white/60">Features built for excellence</span>
                    </div>
                ...
                <div className="w-full px-6 lg:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, i) => (
                            ...
                            >
                                <div className={`w-16 h-16 rounded-2xl ${feature.bg} ${feature.color} flex items-center justify-center mb-8 shadow-xl group-hover:scale-110 transition-transform duration-500`}>
                                    {feature.icon}
                                </div>
            ...
            <section className="py-32 bg-white/[0.01] border-y border-white/10 relative z-10 overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] h-[60%] bg-primary/10 blur-[120px] rounded-full" />
                
                <div className="w-full px-6 lg:px-12 text-center relative z-10">
                    <h2 className="text-5xl font-black mb-10 leading-none">Ready to deploy these modules?</h2>
                    <Link to="/signup">
                        <Button size="lg" className="h-20 px-12 rounded-[24px] bg-primary hover:bg-primary/90 text-white font-black text-xl shadow-glow group">
