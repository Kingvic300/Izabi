    ...
    const features = [
        {
            ...
            title: 'Smart Scan',
            description:
                'Upload PDFs and notes - our system understands the context instantly.',
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
        {
            ...
            description:
                "Get clear summaries that explain the 'Why' behind every concept.",
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
        {
            ...
            title: 'Practice Quiz',
            description:
                'Auto-generate practice quizzes with instant feedback.',
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
        {
            ...
            description:
                'Engage in real-time knowledge duels with fellow students.',
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
        {
            ...
            title: 'Audio Lexicon',
            description:
                'Convert any lesson into interactive audio tailored to your learning style.',
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
        {
            ...
            description:
                'Fluent across Academic English and Local Dialects (Pidgin) for better clarity.',
            color: 'text-primary',
            bg: 'bg-primary/10',
        },
    ];
    return (
        <ErrorBoundary>
            ...
            >
                        ...
                        <div className="hero-content text-center w-full max-w-[1400px] mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
                                <Link to="/signup">
                                    <Button
                                        size="lg"
                                        className="h-16 px-10 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg shadow-glow-primary group"
                                    >
                                ...
                                <a href="#how-it-works">
                                    <Button
                                        variant="ghost"
                                        size="lg"
                                        className="h-16 px-10 rounded-xl font-bold text-lg glass border border-foreground/10 hover:bg-foreground/5 text-foreground"
                                    >
                                        {t('hero.view_env')}
                                    </Button>
                                </a>
                    ...
                    <div className="w-full px-6 lg:px-12">
                        ...
                        <div className="features-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {features.map((feature, i) => (
                                ...
                                >
                                    <div
                                        className={`w-16 h-16 rounded-xl ${feature.bg} ${feature.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-xl`}
                                    >
                                        {feature.icon}
                                    </div>
                ...
                <section
                    id="how-it-works"
                    className="py-32 bg-foreground/5 border-y border-foreground/5"
                >
                            ...
                            {[
                                {
                                    step: '01',
                                    title: 'Upload',
                                    desc: 'Upload your PDFs, notes, or raw texts.',
                                    icon: <FileText />,
                                },
                                {
                                    step: '02',
                                    title: 'Analyze',
                                    desc: 'Izabi identifies key patterns and explains them.',
                                    icon: <Zap />,
                                },
                                {
                                    step: '03',
                                    title: 'Learn',
                                    desc: 'Simulate exams and master the curriculum.',
                                    icon: <Sparkles />,
                                },
                            ].map((item, i) => (
                    ...
                    <div className="w-full px-6 lg:px-12 relative z-10">
                        <div className="text-center mb-24">
                            ...
                            <p className="text-xl text-muted-foreground font-medium max-w-2xl mx-auto">
                                Join students across the continent transforming
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <Card
                                    key={i}
                                    className="glass shadow-2xl border-foreground/5 p-10 hover-lift relative group"
                                >
                                    <div className="flex items-center gap-5 mb-8">
                                        <div
                                            className={`w-14 h-14 rounded-xl ${testimonial.grad} flex items-center justify-center text-white font-bold text-xl shadow-lg`}
                                        >
                                            {testimonial.avatar}
                                        </div>
                                        <div>
                                    ...
                                    <p className="text-muted-foreground font-medium leading-[1.8] italic">
                                        "{testimonial.quote}"
                                    </p>
                                </Card>
                            ))}
                    ...
                    <div className="w-full px-6 lg:px-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center w-full">
                            {[
                                ...
                                >
                                    {plan.hot && (
                                        <div className="absolute top-6 right-6 bg-primary text-white px-3 py-1 rounded-xl text-[10px] font-bold uppercase tracking-widest animate-pulse">
                                            Most Popular
                                        </div>
                                    )}
                                    <div className="mb-10">
                                        ...
                                        <p className="text-sm font-bold opacity-40 mb-6 uppercase tracking-wider text-foreground">
                                            {plan.desc}
                                        </p>
                                        <div className="flex items-baseline gap-2">
                                            ...
                                            <span className="text-xs font-bold opacity-40 text-foreground">
                                                /MONTH
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <Link
                                        to={`/signup?plan=${plan.name.toLowerCase().replace(' ', '-')}`}
                                        className="w-full"
                                    >
                                        <Button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
                            <div>
                                ...
                                <p className="text-lg text-muted-foreground font-medium leading-[1.8] mb-8">
                                    We believe that every student in Africa
                                    deserves an unfair advantage. Izabi was
                                    engineered to democratize elite-level
                                    academic tutoring through accessible,
                                    localized, and intelligent technology.
                                </p>
                                <Button
                                    variant="ghost"
                                    className="font-bold p-0 hover:bg-transparent text-primary hover:gap-3 transition-all"
                                >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="glass p-8 rounded-2xl border border-foreground/10 text-center hover-lift"
                                    >
                ...
                <section className="py-44 relative">
                    <div className="w-full px-6 lg:px-12 text-center relative z-10">
                        ...
                        <h2 className="text-6xl sm:text-7xl font-bold mb-8 tracking-tighter text-foreground">
                            {t('cta.upgrade')}
                        </h2>
                        ...
                        <Link to="/signup">
                            <Button
                                size="lg"
                                className="h-20 px-14 rounded-[28px] bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-2xl shadow-glow-primary group"
                            >
