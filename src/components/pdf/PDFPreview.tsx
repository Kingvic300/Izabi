...
// Use pdfjs-dist CSS for annotation + text layers in v10
                      ...
                      >
                        <div className="relative bg-white rounded-lg shadow-sm">
                          <Page
                              ...
                              renderTextLayer={false} // toggle true if you want selectable text
                              renderAnnotationLayer={false} // toggle true if you want annotations
                          />
