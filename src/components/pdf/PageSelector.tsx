...
export const PageSelector: React.FC<PageSelectorProps> = ({
    ...
    const handleRemovePage = (pageNumber: number) => {
        const newSelection = selectedPages.filter(
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex flex-col md:flex-row items-end md:items-end space-y-3 md:space-y-0 md:space-x-2">
                        ...
                        <span className="text-muted-foreground pb-2 self-end mb-1 md:mb-0">
                            to
                        </span>
                        <div className="flex-1 w-full md:w-auto">
                            <Label
                    ...
                    {selectedPages.length > 0 && (
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Click on a page number to remove it from
                                selection
                            </p>
                        </div>
                    )}
